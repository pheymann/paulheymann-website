...
date:   2018-06-15
categories: Scala
head_title: TypedAPI - Derive HTTP clients and servers from types in Scala
meta_description: Use Scala to derive HTTP clients and servers from types using TypedAPI. And learn what you can do with Scala's type system.
meta_keywords: Scala, Typesystem, Implicits, HTTP
---
